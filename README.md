...
| [Full API Reference](docs/api/README.md) | EN | Autogenerated from public assemblies and XML documentation. Contains detailed technical specifications for all components. |
