...
public static class CssVarMap
{
    ...
    public static Dictionary<string, string> FlattenDesign(this DesignTokens t)
    {
        ...
        v[Css.Tokens.ProgressField.CircularIndeterminateRotationDuration] = t.Progress.CircularIndeterminateRotationDuration;
        v[Css.Tokens.ProgressField.CircularIndeterminateProgressDuration] = t.Progress.CircularIndeterminateProgressDuration;
        #endregion
        ...
        #region SWITCH
        v[Css.Tokens.SwitchField.TrackWidth.Xs] = t.Switch.TrackWidthXs;
        v[Css.Tokens.SwitchField.TrackWidth.Sm] = t.Switch.TrackWidthSm;
        v[Css.Tokens.SwitchField.TrackWidth.Md] = t.Switch.TrackWidthMd;
        v[Css.Tokens.SwitchField.TrackWidth.Lg] = t.Switch.TrackWidthLg;
        v[Css.Tokens.SwitchField.TrackWidth.Xl] = t.Switch.TrackWidthXl;
        v[Css.Tokens.SwitchField.TrackHeight.Xs] = t.Switch.TrackHeightXs;
        v[Css.Tokens.SwitchField.TrackHeight.Sm] = t.Switch.TrackHeightSm;
        v[Css.Tokens.SwitchField.TrackHeight.Md] = t.Switch.TrackHeightMd;
        v[Css.Tokens.SwitchField.TrackHeight.Lg] = t.Switch.TrackHeightLg;
        v[Css.Tokens.SwitchField.TrackHeight.Xl] = t.Switch.TrackHeightXl;
        ...
        v[Css.Tokens.SwitchField.ThumbOffSize.Xs] = t.Switch.ThumbOffSizeXs;
        v[Css.Tokens.SwitchField.ThumbOffSize.Sm] = t.Switch.ThumbOffSizeSm;
        v[Css.Tokens.SwitchField.ThumbOffSize.Md] = t.Switch.ThumbOffSizeMd;
        v[Css.Tokens.SwitchField.ThumbOffSize.Lg] = t.Switch.ThumbOffSizeLg;
        v[Css.Tokens.SwitchField.ThumbOffSize.Xl] = t.Switch.ThumbOffSizeXl;
        v[Css.Tokens.SwitchField.ThumbOnSize.Xs] = t.Switch.ThumbOnSizeXs;
        v[Css.Tokens.SwitchField.ThumbOnSize.Sm] = t.Switch.ThumbOnSizeSm;
        v[Css.Tokens.SwitchField.ThumbOnSize.Md] = t.Switch.ThumbOnSizeMd;
        v[Css.Tokens.SwitchField.ThumbOnSize.Lg] = t.Switch.ThumbOnSizeLg;
        v[Css.Tokens.SwitchField.ThumbOnSize.Xl] = t.Switch.ThumbOnSizeXl;
        v[Css.Tokens.SwitchField.ThumbPressedOffSize.Xs] = t.Switch.ThumbPressedOffSizeXs;
        v[Css.Tokens.SwitchField.ThumbPressedOffSize.Sm] = t.Switch.ThumbPressedOffSizeSm;
        v[Css.Tokens.SwitchField.ThumbPressedOffSize.Md] = t.Switch.ThumbPressedOffSizeMd;
        v[Css.Tokens.SwitchField.ThumbPressedOffSize.Lg] = t.Switch.ThumbPressedOffSizeLg;
        v[Css.Tokens.SwitchField.ThumbPressedOffSize.Xl] = t.Switch.ThumbPressedOffSizeXl;
        v[Css.Tokens.SwitchField.ThumbPressedOnSize.Xs] = t.Switch.ThumbPressedOnSizeXs;
        v[Css.Tokens.SwitchField.ThumbPressedOnSize.Sm] = t.Switch.ThumbPressedOnSizeSm;
        v[Css.Tokens.SwitchField.ThumbPressedOnSize.Md] = t.Switch.ThumbPressedOnSizeMd;
        v[Css.Tokens.SwitchField.ThumbPressedOnSize.Lg] = t.Switch.ThumbPressedOnSizeLg;
        v[Css.Tokens.SwitchField.ThumbPressedOnSize.Xl] = t.Switch.ThumbPressedOnSizeXl;
        v[Css.Tokens.SwitchField.ThumbOffLeft.Xs] = t.Switch.ThumbOffLeftXs;
        v[Css.Tokens.SwitchField.ThumbOffLeft.Sm] = t.Switch.ThumbOffLeftSm;
        v[Css.Tokens.SwitchField.ThumbOffLeft.Md] = t.Switch.ThumbOffLeftMd;
        v[Css.Tokens.SwitchField.ThumbOffLeft.Lg] = t.Switch.ThumbOffLeftLg;
        v[Css.Tokens.SwitchField.ThumbOffLeft.Xl] = t.Switch.ThumbOffLeftXl;
        v[Css.Tokens.SwitchField.ThumbOnLeft.Xs] = t.Switch.ThumbOnLeftXs;
        v[Css.Tokens.SwitchField.ThumbOnLeft.Sm] = t.Switch.ThumbOnLeftSm;
        v[Css.Tokens.SwitchField.ThumbOnLeft.Md] = t.Switch.ThumbOnLeftMd;
        v[Css.Tokens.SwitchField.ThumbOnLeft.Lg] = t.Switch.ThumbOnLeftLg;
        v[Css.Tokens.SwitchField.ThumbOnLeft.Xl] = t.Switch.ThumbOnLeftXl;
