...
public sealed record TooltipTokens
{
    ...
    [CssVar(TooltipPopup.SurfaceColor)] public string SurfaceColor { get; init; } = "var(--flare-color-inverse-surface)";

    /// <summary>Color of the tooltip text.</summary>
    [CssVar(TooltipPopup.TextColor)] public string TextColor { get; init; } = "var(--flare-color-inverse-on-surface)";

    /// <summary>Border radius of the tooltip.</summary>
    [CssVar(TooltipPopup.Radius)] public string Radius { get; init; } = "var(--flare-shape-extra-small)";
    ...
    [CssVar(TooltipPopup.FontFamily)] public string FontFamily { get; init; } = "var(--flare-typescale-body-small-font)";

    /// <summary>Font size of the tooltip text.</summary>
    [CssVar(TooltipPopup.FontSize)] public string FontSize { get; init; } = "var(--flare-typescale-body-small-size)";
    ...
    [CssVar(TooltipPopup.LineHeight)] public string LineHeight { get; init; } = "var(--flare-typescale-body-small-height)";
    ...
    [CssVar(TooltipPopup.TransitionDuration)] public string TransitionDuration { get; init; } = "var(--flare-motion-duration-short1)";

    /// <summary>Transition easing for show/hide.</summary>
    [CssVar(TooltipPopup.TransitionEasing)] public string TransitionEasing { get; init; } = "var(--flare-motion-easing-standard)";
