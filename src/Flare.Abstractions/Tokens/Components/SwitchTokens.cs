...
public sealed record SwitchTokens
{
    ...
    [CssVar(SwitchField.TrackRadius)] public string TrackRadius { get; init; } = "var(--flare-shape-full)";

    /// <summary>Background color of the track (unchecked).</summary>
    [CssVar(SwitchField.TrackColor)] public string TrackColor { get; init; } = "var(--flare-color-surface-container-highest)";

    /// <summary>Border color of the track (unchecked).</summary>
    [CssVar(SwitchField.TrackBorderColor)] public string TrackBorderColor { get; init; } = "var(--flare-color-outline)";
    ...
    [CssVar(SwitchField.TrackColorSelected)] public string TrackColorSelected { get; init; } = "var(--flare-color-primary)";

    /// <summary>Border color of the track (checked).</summary>
    [CssVar(SwitchField.TrackBorderColorSelected)] public string TrackBorderColorSelected { get; init; } = "var(--flare-color-primary)";
    ...
    [CssVar(SwitchField.ThumbColor)] public string ThumbColor { get; init; } = "var(--flare-color-outline)";

    /// <summary>Background color of the thumb (checked).</summary>
    [CssVar(SwitchField.ThumbColorSelected)] public string ThumbColorSelected { get; init; } = "var(--flare-color-on-primary)";

    /// <summary>Color of the thumb icon (unchecked).</summary>
    [CssVar(SwitchField.ThumbIconColor)] public string ThumbIconColor { get; init; } = "var(--flare-color-surface-container-highest)";

    /// <summary>Color of the thumb icon (checked).</summary>
    [CssVar(SwitchField.ThumbIconColorSelected)] public string ThumbIconColorSelected { get; init; } = "var(--flare-color-primary)";
    ...
    [CssVar(SwitchField.FocusOutlineColor)] public string FocusOutlineColor { get; init; } = "var(--flare-color-primary)";
    ...
    [CssVar(SwitchField.TransitionDuration)] public string TransitionDuration { get; init; } = "var(--flare-motion-duration-short2)";

    /// <summary>Transition easing for state changes.</summary>
    [CssVar(SwitchField.TransitionEasing)] public string TransitionEasing { get; init; } = "var(--flare-motion-easing-standard)";

    /// <summary>Background color of the pressed state layer.</summary>
    [CssVar(SwitchField.PressedLayerColor)] public string PressedLayerColor { get; init; } = "var(--flare-color-primary)";

    /// <summary>Opacity of the pressed state layer.</summary>
    [CssVar(SwitchField.PressedLayerOpacity)] public string PressedLayerOpacity { get; init; } = "var(--flare-state-pressed-opacity)";

    /// <summary>Disabled opacity of the switch.</summary>
    [CssVar(SwitchField.DisabledOpacity)] public string DisabledOpacity { get; init; } = "var(--flare-state-disabled-opacity)";
}
