...
public static class Layout
{
    ...
    /// <summary>The <c>flare-layout--drawer-open</c> CSS class.</summary>
    public const string DrawerOpen = "flare-layout--drawer-open";
    /// <summary>The <c>flare-layout__body</c> CSS class.</summary>
    public const string Body = "flare-layout__body";
    /// <summary>The <c>flare-layout__main</c> CSS class.</summary>
    public const string Main = "flare-layout__main";
    ...
    /// <summary>The <c>flare-layout-content</c> CSS class.</summary>
