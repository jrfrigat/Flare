...
public static class TagInput
{
    ...
    // The rendered chips + remove button reuse the shared FlareChipStrip (Css.Classes.Multiselect.Chip /
    // ChipRemove); the suggestion popup uses the shared Listbox.Dropdown + Listbox.Empty (listbox.css).
}
