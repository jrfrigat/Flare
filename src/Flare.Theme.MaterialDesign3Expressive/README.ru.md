...
Тема Material Design 3 (Expressive), светлая и тёмная, для библиотеки компонентов
...
а раздел после неё говорит, что эта тема делает сверх базовой.
...
- **Группа кнопок обменивается шириной при нажатии**: нажатый сегмент растёт, соседние отдают ровно
