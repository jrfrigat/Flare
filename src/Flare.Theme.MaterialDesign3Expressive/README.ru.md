...
| Индикаторы прогресса (линейный, круговой) | `FlareProgress` | `Variant="ProgressVariant.Linear\|Circular"`; для Expressive-волны добавьте `Class="@Flare.Css.Classes.Md3e.Progress.Wave"` |
