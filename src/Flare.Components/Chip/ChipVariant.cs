...
/// <summary>
/// Visual style of a <see cref="FlareChip"/>, independent of the active theme. Provides three chip
/// styles: <see cref="Outlined"/> (the default - a bordered, transparent chip),
...
{
    /// <summary>Bordered chip with a transparent background. The default.</summary>
    Outlined,
