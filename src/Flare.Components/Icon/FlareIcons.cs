...
{
    // -- Actions ---------------------------------------------------------------
    /// <summary>Material Symbols icon name <c>add</c> (use with <c>FlareIcon</c>).</summary>
    public const string Add = "add";
    /// <summary>Material Symbols icon name <c>edit</c> (use with <c>FlareIcon</c>).</summary>
    public const string Edit = "edit";
    /// <summary>Material Symbols icon name <c>delete</c> (use with <c>FlareIcon</c>).</summary>
    public const string Delete = "delete";
    /// <summary>Material Symbols icon name <c>save</c> (use with <c>FlareIcon</c>).</summary>
    public const string Save = "save";
    /// <summary>Material Symbols icon name <c>share</c> (use with <c>FlareIcon</c>).</summary>
    public const string Share = "share";
    /// <summary>Material Symbols icon name <c>send</c> (use with <c>FlareIcon</c>).</summary>
    public const string Send = "send";
    /// <summary>Material Symbols icon name <c>reply</c> (use with <c>FlareIcon</c>).</summary>
    public const string Reply = "reply";
    /// <summary>Material Symbols icon name <c>forward</c> (use with <c>FlareIcon</c>).</summary>
    public const string Forward = "forward";
    /// <summary>Material Symbols icon name <c>download</c> (use with <c>FlareIcon</c>).</summary>
    public const string Download = "download";
    /// <summary>Material Symbols icon name <c>upload</c> (use with <c>FlareIcon</c>).</summary>
    public const string Upload = "upload";
    /// <summary>Material Symbols icon name <c>print</c> (use with <c>FlareIcon</c>).</summary>
    public const string Print = "print";
    /// <summary>Material Symbols icon name <c>refresh</c> (use with <c>FlareIcon</c>).</summary>
    public const string Refresh = "refresh";
    /// <summary>Material Symbols icon name <c>tune</c> (use with <c>FlareIcon</c>).</summary>
    public const string Tune = "tune";
    /// <summary>Material Symbols icon name <c>search</c> (use with <c>FlareIcon</c>).</summary>
    public const string Search = "search";
    /// <summary>Material Symbols icon name <c>filter_list</c> (use with <c>FlareIcon</c>).</summary>
    public const string FilterList = "filter_list";
    /// <summary>Material Symbols icon name <c>sort</c> (use with <c>FlareIcon</c>).</summary>
    public const string Sort = "sort";
    /// <summary>Material Symbols icon name <c>drag_handle</c> (use with <c>FlareIcon</c>).</summary>
    public const string DragHandle = "drag_handle";
    /// <summary>Material Symbols icon name <c>copy_all</c> (use with <c>FlareIcon</c>).</summary>
    public const string CopyAll = "copy_all";
    /// <summary>Material Symbols icon name <c>open_in_new</c> (use with <c>FlareIcon</c>).</summary>
    public const string OpenInNew = "open_in_new";

    // -- Navigation ------------------------------------------------------------
    /// <summary>Material Symbols icon name <c>home</c> (use with <c>FlareIcon</c>).</summary>
    public const string Home = "home";
    /// <summary>Material Symbols icon name <c>menu</c> (use with <c>FlareIcon</c>).</summary>
    public const string Menu = "menu";
    /// <summary>Material Symbols icon name <c>arrow_back</c> (use with <c>FlareIcon</c>).</summary>
    public const string ArrowBack = "arrow_back";
    /// <summary>Material Symbols icon name <c>arrow_forward</c> (use with <c>FlareIcon</c>).</summary>
    public const string ArrowForward = "arrow_forward";
    /// <summary>Material Symbols icon name <c>arrow_drop_down</c> (use with <c>FlareIcon</c>).</summary>
    public const string ArrowDropDown = "arrow_drop_down";
    /// <summary>Material Symbols icon name <c>arrow_drop_up</c> (use with <c>FlareIcon</c>).</summary>
    public const string ArrowDropUp = "arrow_drop_up";
    /// <summary>Material Symbols icon name <c>chevron_right</c> (use with <c>FlareIcon</c>).</summary>
    public const string ChevronRight = "chevron_right";
    /// <summary>Material Symbols icon name <c>chevron_left</c> (use with <c>FlareIcon</c>).</summary>
    public const string ChevronLeft = "chevron_left";
    /// <summary>Material Symbols icon name <c>expand_more</c> (use with <c>FlareIcon</c>).</summary>
    public const string ExpandMore = "expand_more";
    /// <summary>Material Symbols icon name <c>expand_less</c> (use with <c>FlareIcon</c>).</summary>
    public const string ExpandLess = "expand_less";
    /// <summary>Material Symbols icon name <c>first_page</c> (use with <c>FlareIcon</c>).</summary>
    public const string FirstPage = "first_page";
    /// <summary>Material Symbols icon name <c>last_page</c> (use with <c>FlareIcon</c>).</summary>
    public const string LastPage = "last_page";
    /// <summary>Material Symbols icon name <c>more_vert</c> (use with <c>FlareIcon</c>).</summary>
    public const string MoreVert = "more_vert";
    /// <summary>Material Symbols icon name <c>more_horiz</c> (use with <c>FlareIcon</c>).</summary>
    public const string MoreHoriz = "more_horiz";

    // -- Status & Feedback -----------------------------------------------------
    /// <summary>Material Symbols icon name <c>info</c> (use with <c>FlareIcon</c>).</summary>
    public const string Info = "info";
    /// <summary>Material Symbols icon name <c>warning</c> (use with <c>FlareIcon</c>).</summary>
    public const string Warning = "warning";
    /// <summary>Material Symbols icon name <c>error</c> (use with <c>FlareIcon</c>).</summary>
    public const string Error = "error";
    /// <summary>Material Symbols icon name <c>check</c> (use with <c>FlareIcon</c>).</summary>
    public const string Check = "check";
    /// <summary>Material Symbols icon name <c>check_circle</c> (use with <c>FlareIcon</c>).</summary>
    public const string CheckCircle = "check_circle";
    /// <summary>Material Symbols icon name <c>cancel</c> (use with <c>FlareIcon</c>).</summary>
    public const string Cancel = "cancel";
    /// <summary>Material Symbols icon name <c>done_all</c> (use with <c>FlareIcon</c>).</summary>
    public const string DoneAll = "done_all";

    // -- People & Communication ------------------------------------------------
    /// <summary>Material Symbols icon name <c>person</c> (use with <c>FlareIcon</c>).</summary>
    public const string Person = "person";
    /// <summary>Material Symbols icon name <c>group</c> (use with <c>FlareIcon</c>).</summary>
    public const string Group = "group";
    /// <summary>Material Symbols icon name <c>email</c> (use with <c>FlareIcon</c>).</summary>
    public const string Email = "email";
    /// <summary>Material Symbols icon name <c>phone</c> (use with <c>FlareIcon</c>).</summary>
    public const string Phone = "phone";
    /// <summary>Material Symbols icon name <c>notifications</c> (use with <c>FlareIcon</c>).</summary>
    public const string Notifications = "notifications";
    /// <summary>Material Symbols icon name <c>inbox</c> (use with <c>FlareIcon</c>).</summary>
    public const string Inbox = "inbox";

    // -- Files & Folders -------------------------------------------------------
    /// <summary>Material Symbols icon name <c>folder</c> (use with <c>FlareIcon</c>).</summary>
    public const string Folder = "folder";
    /// <summary>Material Symbols icon name <c>folder_open</c> (use with <c>FlareIcon</c>).</summary>
    public const string FolderOpen = "folder_open";
    /// <summary>Material Symbols icon name <c>file_copy</c> (use with <c>FlareIcon</c>).</summary>
    public const string FileCopy = "file_copy";
    /// <summary>Material Symbols icon name <c>attach_file</c> (use with <c>FlareIcon</c>).</summary>
    public const string AttachFile = "attach_file";
    /// <summary>Material Symbols icon name <c>link</c> (use with <c>FlareIcon</c>).</summary>
    public const string Link = "link";
    /// <summary>Material Symbols icon name <c>image</c> (use with <c>FlareIcon</c>).</summary>
    public const string Image = "image";
    /// <summary>Material Symbols icon name <c>photo_camera</c> (use with <c>FlareIcon</c>).</summary>
    public const string PhotoCamera = "photo_camera";

    // -- UI / Misc -------------------------------------------------------------
    /// <summary>Material Symbols icon name <c>settings</c> (use with <c>FlareIcon</c>).</summary>
    public const string Settings = "settings";
    /// <summary>Material Symbols icon name <c>favorite</c> (use with <c>FlareIcon</c>).</summary>
    public const string Favorite = "favorite";
    /// <summary>Material Symbols icon name <c>star</c> (use with <c>FlareIcon</c>).</summary>
    public const string Star = "star";
    /// <summary>Material Symbols icon name <c>visibility</c> (use with <c>FlareIcon</c>).</summary>
    public const string Visibility = "visibility";
    /// <summary>Material Symbols icon name <c>visibility_off</c> (use with <c>FlareIcon</c>).</summary>
    public const string VisibilityOff = "visibility_off";
    /// <summary>Material Symbols icon name <c>lock</c> (use with <c>FlareIcon</c>).</summary>
    public const string Lock = "lock";
    /// <summary>Material Symbols icon name <c>calendar_today</c> (use with <c>FlareIcon</c>).</summary>
    public const string CalendarToday = "calendar_today";
    /// <summary>Material Symbols icon name <c>schedule</c> (use with <c>FlareIcon</c>).</summary>
    public const string Schedule = "schedule";
    /// <summary>Material Symbols icon name <c>thumb_up</c> (use with <c>FlareIcon</c>).</summary>
    public const string ThumbUp = "thumb_up";
    /// <summary>Material Symbols icon name <c>thumb_down</c> (use with <c>FlareIcon</c>).</summary>
    public const string ThumbDown = "thumb_down";
    /// <summary>Material Symbols icon name <c>close</c> (use with <c>FlareIcon</c>).</summary>
    public const string Close = "close";

    // -- Theme & Appearance ----------------------------------------------------
    /// <summary>Material Symbols icon name <c>dark_mode</c> (use with <c>FlareIcon</c>).</summary>
    public const string DarkMode = "dark_mode";
    /// <summary>Material Symbols icon name <c>light_mode</c> (use with <c>FlareIcon</c>).</summary>
    public const string LightMode = "light_mode";
    /// <summary>Material Symbols icon name <c>palette</c> (use with <c>FlareIcon</c>).</summary>
    public const string Palette = "palette";

    // -- Developer -------------------------------------------------------------
    /// <summary>Material Symbols icon name <c>code</c> (use with <c>FlareIcon</c>).</summary>
    public const string Code = "code";
    /// <summary>Material Symbols icon name <c>bug_report</c> (use with <c>FlareIcon</c>).</summary>
    public const string BugReport = "bug_report";
    /// <summary>Material Symbols icon name <c>rocket_launch</c> (use with <c>FlareIcon</c>).</summary>
    public const string RocketLaunch = "rocket_launch";
    /// <summary>Material Symbols icon name <c>local_fire_department</c> (use with <c>FlareIcon</c>).</summary>
    public const string LocalFireDepartment = "local_fire_department";
    /// <summary>Material Symbols icon name <c>flash_on</c> (use with <c>FlareIcon</c>).</summary>
    public const string FlashOn = "flash_on";
    /// <summary>Material Symbols icon name <c>speed</c> (use with <c>FlareIcon</c>).</summary>
    public const string Speed = "speed";

    // -- All icons as name -> svg-path (internal lookup used by FlareIcon) ------
    internal static readonly IReadOnlyDictionary<string, string> Paths =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [CopyAll] = "M4 5h2v2H4zm0 4h2v2H4zm0 4h2v2H4zm4-8h12v2H8zm0 4h12v2H8zm0 4h12v2H8zM2 19h12v2H2zm14 0h6v2h-6z",
            ...
            [ThumbDown] = "M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v2c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L10.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z",
            ...
            [Forward] = "M14 9l7 7-7 7v-4.1c-5 0-8.5 1.6-11 5.1 1-5 4-10 11-11V9z",
            ...
            [FileCopy] = "M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z",
            ...
            [PhotoCamera] = "M12 15.2c1.77 0 3.2-1.43 3.2-3.2S13.77 8.8 12 8.8 8.8 10.23 8.8 12s1.43 3.2 3.2 3.2zM9 2L7.17 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z",
        };

    /// <summary>All icon names in the built-in pack, sorted alphabetically.</summary>
    public static IEnumerable<string> All => Paths.Keys.OrderBy(k => k);

    /// <summary>Raw SVG inner content for brand marks (use with <c>FlareIcon</c>'s <c>Icon</c>).</summary>
    public static class Brands
    {
        /// <summary>
        /// Flare brand mark: a stylized "F" formed from flame tongues. Authored on a 1024 grid,
        /// scaled into the shared 24x24 icon viewBox via a transform. Pass to <c>FlareIcon.Icon</c>.
        /// </summary>
