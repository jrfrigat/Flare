...
public enum MaterialSymbolFamily
{
...
public sealed record FlareMaterialIcon : FlareIcon
{
    ...
    /// <summary>Glyph font family. Default <see cref="MaterialSymbolFamily.Rounded"/>.</summary>
    ...
    {
        MaterialSymbolFamily.Outlined => "material-symbols-outlined",
        MaterialSymbolFamily.Sharp => "material-symbols-sharp",
