...
Тема Liquid Glass (матовое стекло, слои глубины), светлая и темная, для библиотеки компонентов
...
бликом, в традиции платформ Apple. Отдельного словаря компонентов у нее нет, поэтому таблица ниже -
...
- **Никакого backdrop blur.** Это осознанно и ради производительности: глубина читается из слоев и
