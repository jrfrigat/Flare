...
internal class LiquidGlassTokens
{
    ...
    internal static readonly ShapeTokens Shape = new()
    {
        ...
        // The glass responds through blur and highlight rather than by reshaping its corners.
        MorphDuration = "0s",
    ...
    internal static readonly ColorScheme LightColors = new()
    {
        ...
        SurfaceDim = "#D1D1D6",
        PrimaryFixed = "#D6E9FF",
        PrimaryFixedDim = "#0A84FF",
        OnPrimaryFixed = "#003E80",
        OnPrimaryFixedVariant = "#003E80",
        SecondaryFixed = "#E9E9EB",
        SecondaryFixedDim = "#98989D",
        OnSecondaryFixed = "#1C1C1E",
        OnSecondaryFixedVariant = "#1C1C1E",
        TertiaryFixed = "#F2E4FB",
        TertiaryFixedDim = "#BF5AF2",
        OnTertiaryFixed = "#4A1A6B",
        OnTertiaryFixedVariant = "#4A1A6B",
        Background = "#EEF1F6",
        OnBackground = "#1C1C1E",
        Outline = "#C6C6C8",
