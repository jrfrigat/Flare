...
internal static class MaterialDesign2Tokens
{
    ...
    internal static readonly ButtonTokens Button = new()
    {
        ...
        // Material Design 2 here fades the whole control; no repaint, so the disabled colours are never mixed in.
    ...
    internal static readonly ColorScheme LightColors = new()
    {
        ...
        SurfaceDim = "#E0E0E0",
        PrimaryFixed = "#3700B3",
        PrimaryFixedDim = "#BB86FC",
        OnPrimaryFixed = "#FFFFFF",
        OnPrimaryFixedVariant = "#FFFFFF",
        SecondaryFixed = "#018786",
        SecondaryFixedDim = "#03DAC6",
        OnSecondaryFixed = "#FFFFFF",
        OnSecondaryFixedVariant = "#FFFFFF",
        TertiaryFixed = "#B2DFDB",
        TertiaryFixedDim = "#03DAC6",
        OnTertiaryFixed = "#00201E",
        OnTertiaryFixedVariant = "#00201E",
