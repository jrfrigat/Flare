...
public sealed record FabTokens
{
    ...
    public string PaddingSm { get; init; } = "0.5rem";
    ...
    public string PaddingLg { get; init; } = "1.75rem";
    ...
    public string RadiusSm { get; init; } = "var(--flare-shape-medium)";
    /// <summary>Radius md token (<c>var(--flare-shape-large)</c>).</summary>
    public string RadiusMd { get; init; } = "var(--flare-shape-large)";
    /// <summary>Radius lg token (<c>var(--flare-shape-extra-large)</c>).</summary>
    public string RadiusLg { get; init; } = "var(--flare-shape-extra-large)";
    ...
    public string Shadow { get; init; } = "var(--flare-elevation-3)";
    /// <summary>Hover shadow token (<c>var(--flare-elevation-4)</c>).</summary>
    public string HoverShadow { get; init; } = "var(--flare-elevation-4)";

    // --- 5. ОТСТУП якоря от края экрана ---
    /// <summary>Anchor offset token (<c>1.5rem</c>).</summary>
    public string AnchorOffset { get; init; } = "1.5rem";
}
