...
public static class FlareIcons
{
    ...
    public static FlareSvgIcon Delete { get; } = Reg("delete", "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z");
    /// <summary>The built-in <c>save</c> icon.</summary>
    public static FlareSvgIcon Save { get; } = Reg("save", "M17 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V7l-4-4zm-5 16c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm3-10H5V5h10v4z");
    /// <summary>The built-in <c>share</c> icon.</summary>
    public static FlareSvgIcon Share { get; } = Reg("share", "M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z");
    /// <summary>The built-in <c>send</c> icon.</summary>
    public static FlareSvgIcon Send { get; } = Reg("send", "M2.01 21L23 12 2.01 3 2 10l15 2-15 2z");
    /// <summary>The built-in <c>reply</c> icon.</summary>
    public static FlareSvgIcon Reply { get; } = Reg("reply", "M10 9V5l-7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z");
    /// <summary>The built-in <c>forward</c> icon.</summary>
    public static FlareSvgIcon Forward { get; } = Reg("forward", "M14 9l7 7-7 7v-4.1c-5 0-8.5 1.6-11 5.1 1-5 4-10 11-11V9z");
    /// <summary>The built-in <c>download</c> icon.</summary>
    public static FlareSvgIcon Download { get; } = Reg("download", "M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z");
    /// <summary>The built-in <c>upload</c> icon.</summary>
    public static FlareSvgIcon Upload { get; } = Reg("upload", "M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z");
    /// <summary>The built-in <c>print</c> icon.</summary>
    public static FlareSvgIcon Print { get; } = Reg("print", "M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12V3z");
    /// <summary>The built-in <c>refresh</c> icon.</summary>
    public static FlareSvgIcon Refresh { get; } = Reg("refresh", "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z");
    /// <summary>The built-in <c>tune</c> icon.</summary>
    public static FlareSvgIcon Tune { get; } = Reg("tune", "M3 17v2h6v-2H3zM3 5v2h10V5H3zm10 16v-2h8v-2h-8v-2h-2v6h2zM7 9v2H3v2h4v2h2V9H7zm14 4v-2H11v2h10zm-6-4h2V7h4V5h-4V3h-2v6z");
    /// <summary>The built-in <c>search</c> icon.</summary>
    public static FlareSvgIcon Search { get; } = Reg("search", "M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z");
    /// <summary>The built-in <c>filter_list</c> icon.</summary>
    public static FlareSvgIcon FilterList { get; } = Reg("filter_list", "M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z");
    /// <summary>The built-in <c>sort</c> icon.</summary>
    public static FlareSvgIcon Sort { get; } = Reg("sort", "M3 18h6v-2H3v2zM3 6v2h18V6H3zm0 7h12v-2H3v2z");
    /// <summary>The built-in <c>drag_handle</c> icon.</summary>
    public static FlareSvgIcon DragHandle { get; } = Reg("drag_handle", "M20 9H4v2h16V9zM4 15h16v-2H4v2z");
    /// <summary>The built-in <c>copy_all</c> icon.</summary>
    public static FlareSvgIcon CopyAll { get; } = Reg("copy_all", "M4 5h2v2H4zm0 4h2v2H4zm0 4h2v2H4zm4-8h12v2H8zm0 4h12v2H8zm0 4h12v2H8zM2 19h12v2H2zm14 0h6v2h-6z");
    /// <summary>The built-in <c>open_in_new</c> icon.</summary>
    public static FlareSvgIcon OpenInNew { get; } = Reg("open_in_new", "M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z");
    /// <summary>The built-in <c>home</c> icon.</summary>
    public static FlareSvgIcon Home { get; } = Reg("home", "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z");
    /// <summary>The built-in <c>menu</c> icon.</summary>
    public static FlareSvgIcon Menu { get; } = Reg("menu", "M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z");
    /// <summary>The built-in <c>arrow_back</c> icon.</summary>
    public static FlareSvgIcon ArrowBack { get; } = Reg("arrow_back", "M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z");
    /// <summary>The built-in <c>arrow_forward</c> icon.</summary>
    public static FlareSvgIcon ArrowForward { get; } = Reg("arrow_forward", "M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z");
    /// <summary>The built-in <c>arrow_drop_down</c> icon.</summary>
    public static FlareSvgIcon ArrowDropDown { get; } = Reg("arrow_drop_down", "M7 10l5 5 5-5z");
    /// <summary>The built-in <c>arrow_drop_up</c> icon.</summary>
    public static FlareSvgIcon ArrowDropUp { get; } = Reg("arrow_drop_up", "M7 14l5-5 5 5z");
    /// <summary>The built-in <c>chevron_right</c> icon.</summary>
    public static FlareSvgIcon ChevronRight { get; } = Reg("chevron_right", "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z");
    /// <summary>The built-in <c>chevron_left</c> icon.</summary>
    public static FlareSvgIcon ChevronLeft { get; } = Reg("chevron_left", "M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z");
    /// <summary>The built-in <c>expand_more</c> icon.</summary>
    public static FlareSvgIcon ExpandMore { get; } = Reg("expand_more", "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z");
    /// <summary>The built-in <c>expand_less</c> icon.</summary>
    public static FlareSvgIcon ExpandLess { get; } = Reg("expand_less", "M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z");
    /// <summary>The built-in <c>first_page</c> icon.</summary>
    public static FlareSvgIcon FirstPage { get; } = Reg("first_page", "M18.41 16.59L13.82 12l4.59-4.59L17 6l-6 6 6 6zM6 6h2v12H6z");
    /// <summary>The built-in <c>last_page</c> icon.</summary>
    public static FlareSvgIcon LastPage { get; } = Reg("last_page", "M5.59 7.41L10.18 12l-4.59 4.59L7 18l6-6-6-6zM16 6h2v12h-2z");
    /// <summary>The built-in <c>more_vert</c> icon.</summary>
    public static FlareSvgIcon MoreVert { get; } = Reg("more_vert", "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z");
    /// <summary>The built-in <c>more_horiz</c> icon.</summary>
    public static FlareSvgIcon MoreHoriz { get; } = Reg("more_horiz", "M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z");
    /// <summary>The built-in <c>info</c> icon.</summary>
    public static FlareSvgIcon Info { get; } = Reg("info", "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z");
    /// <summary>The built-in <c>warning</c> icon.</summary>
    public static FlareSvgIcon Warning { get; } = Reg("warning", "M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z");
    /// <summary>The built-in <c>error</c> icon.</summary>
    public static FlareSvgIcon Error { get; } = Reg("error", "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z");
    /// <summary>The built-in <c>check</c> icon.</summary>
    public static FlareSvgIcon Check { get; } = Reg("check", "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z");
    /// <summary>The built-in <c>check_circle</c> icon.</summary>
    public static FlareSvgIcon CheckCircle { get; } = Reg("check_circle", "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z");
    /// <summary>The built-in <c>cancel</c> icon.</summary>
    public static FlareSvgIcon Cancel { get; } = Reg("cancel", "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z");
    /// <summary>The built-in <c>done_all</c> icon.</summary>
    public static FlareSvgIcon DoneAll { get; } = Reg("done_all", "M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z");
    /// <summary>The built-in <c>person</c> icon.</summary>
    public static FlareSvgIcon Person { get; } = Reg("person", "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z");
    /// <summary>The built-in <c>group</c> icon.</summary>
    public static FlareSvgIcon Group { get; } = Reg("group", "M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z");
    /// <summary>The built-in <c>email</c> icon.</summary>
    public static FlareSvgIcon Email { get; } = Reg("email", "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z");
    /// <summary>The built-in <c>phone</c> icon.</summary>
    public static FlareSvgIcon Phone { get; } = Reg("phone", "M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z");
    /// <summary>The built-in <c>notifications</c> icon.</summary>
    public static FlareSvgIcon Notifications { get; } = Reg("notifications", "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z");
    /// <summary>The built-in <c>inbox</c> icon.</summary>
    public static FlareSvgIcon Inbox { get; } = Reg("inbox", "M19 3H4.99c-1.11 0-1.98.89-1.98 2L3 19c0 1.1.88 2 1.99 2H19c1.1 0 2-.9 2-2V5c0-1.11-.9-2-2-2zm0 12h-4c0 1.66-1.35 3-3 3s-3-1.34-3-3H4.99V5H19v10z");
    /// <summary>The built-in <c>folder</c> icon.</summary>
    public static FlareSvgIcon Folder { get; } = Reg("folder", "M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z");
    /// <summary>The built-in <c>folder_open</c> icon.</summary>
    public static FlareSvgIcon FolderOpen { get; } = Reg("folder_open", "M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 12H4V8h16v10z");
    /// <summary>The built-in <c>file_copy</c> icon.</summary>
    public static FlareSvgIcon FileCopy { get; } = Reg("file_copy", "M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z");
    /// <summary>The built-in <c>attach_file</c> icon.</summary>
    public static FlareSvgIcon AttachFile { get; } = Reg("attach_file", "M16.5 6v11.5c0 2.21-1.79 4-4 4s-4-1.79-4-4V5c0-1.38 1.12-2.5 2.5-2.5s2.5 1.12 2.5 2.5v10.5c0 .55-.45 1-1 1s-1-.45-1-1V6H10v9.5c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5V5c0-2.21-1.79-4-4-4S7 2.79 7 5v12.5c0 3.04 2.46 5.5 5.5 5.5s5.5-2.46 5.5-5.5V6h-1.5z");
    /// <summary>The built-in <c>link</c> icon.</summary>
    public static FlareSvgIcon Link { get; } = Reg("link", "M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z");
    /// <summary>The built-in <c>image</c> icon.</summary>
    public static FlareSvgIcon Image { get; } = Reg("image", "M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z");
    /// <summary>The built-in <c>photo_camera</c> icon.</summary>
    public static FlareSvgIcon PhotoCamera { get; } = Reg("photo_camera", "M12 15.2c1.77 0 3.2-1.43 3.2-3.2S13.77 8.8 12 8.8 8.8 10.23 8.8 12s1.43 3.2 3.2 3.2zM9 2L7.17 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z");
    /// <summary>The built-in <c>settings</c> icon.</summary>
    public static FlareSvgIcon Settings { get; } = Reg("settings", "M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58c-.18.14-.23.41-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z");
    /// <summary>The built-in <c>favorite</c> icon.</summary>
    public static FlareSvgIcon Favorite { get; } = Reg("favorite", "M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z");
    /// <summary>The built-in <c>star</c> icon.</summary>
    public static FlareSvgIcon Star { get; } = Reg("star", "M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z");
    /// <summary>The built-in <c>visibility</c> icon.</summary>
    public static FlareSvgIcon Visibility { get; } = Reg("visibility", "M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z");
    /// <summary>The built-in <c>visibility_off</c> icon.</summary>
    public static FlareSvgIcon VisibilityOff { get; } = Reg("visibility_off", "M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.43-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46C3.08 8.3 1.78 10.02 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.16c0-1.66-1.34-3-3-3l-.17.01z");
    /// <summary>The built-in <c>lock</c> icon.</summary>
    public static FlareSvgIcon Lock { get; } = Reg("lock", "M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z");
    ...
    public static FlareSvgIcon ThumbDown { get; } = Reg("thumb_down", "M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v2c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L10.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z");
    /// <summary>The built-in <c>close</c> icon.</summary>
    public static FlareSvgIcon Close { get; } = Reg("close", "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z");
    /// <summary>The built-in <c>dark_mode</c> icon.</summary>
    public static FlareSvgIcon DarkMode { get; } = Reg("dark_mode", "M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9c0-.46-.04-.92-.1-1.36-.98 1.37-2.58 2.26-4.4 2.26-2.98 0-5.4-2.42-5.4-5.4 0-1.81.89-3.42 2.26-4.4-.44-.06-.9-.1-1.36-.1z");
    /// <summary>The built-in <c>light_mode</c> icon.</summary>
    public static FlareSvgIcon LightMode { get; } = Reg("light_mode", "M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79 1.42-1.41zM4 10.5H1v2h3v-2zm9-9.95h-2V3.5h2V.55zm7.45 3.91l-1.41-1.41-1.79 1.79 1.41 1.41 1.79-1.79zm-3.21 13.7l1.79 1.8 1.41-1.41-1.8-1.79-1.4 1.4zM20 10.5v2h3v-2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm-1 16.95h2V19.5h-2v2.95zm-7.45-3.91l1.41 1.41 1.79-1.8-1.41-1.41-1.79 1.8z");
    /// <summary>The built-in <c>palette</c> icon.</summary>
    public static FlareSvgIcon Palette { get; } = Reg("palette", "M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c2.76 0 5-2.24 5-5 0-4.42-4.03-8-9-8zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 9 6.5 9 8 9.67 8 10.5 7.33 12 6.5 12zm3-4C8.67 8 8 7.33 8 6.5S8.67 5 9.5 5s1.5.67 1.5 1.5S10.33 8 9.5 8zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 5 14.5 5s1.5.67 1.5 1.5S15.33 8 14.5 8zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 9 17.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z");
    /// <summary>The built-in <c>code</c> icon.</summary>
    public static FlareSvgIcon Code { get; } = Reg("code", "M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z");
    /// <summary>The built-in <c>bug_report</c> icon.</summary>
    public static FlareSvgIcon BugReport { get; } = Reg("bug_report", "M20 8h-2.81c-.45-.78-1.07-1.45-1.82-1.96L17 4.41 15.59 3l-2.17 2.17C12.96 5.06 12.49 5 12 5c-.49 0-.96.06-1.41.17L8.41 3 7 4.41l1.62 1.63C7.88 6.55 7.26 7.22 6.81 8H4v2h2.09c-.05.33-.09.66-.09 1v1H4v2h2v1c0 .34.04.67.09 1H4v2h2.81c1.04 1.79 2.97 3 5.19 3s4.15-1.21 5.19-3H20v-2h-2.09c.05-.33.09-.66.09-1v-1h2v-2h-2v-1c0-.34-.04-.67-.09-1H20V8zm-6 8h-4v-2h4v2zm0-4h-4v-2h4v2z");
    /// <summary>The built-in <c>rocket_launch</c> icon.</summary>
    public static FlareSvgIcon RocketLaunch { get; } = Reg("rocket_launch", "M9.19 6.35c-2.04 2.29-3.44 5.58-3.57 5.89L2 10.69l4.05-4.05c.06-.06.28-.26.68-.37L9.19 6.35zm.82 11.46l-1.56-1.56-1.56-1.56 2.5-1.62c.3-.13 3.59-1.53 5.89-3.57l-.11 2.46c-.11.4-.31.62-.37.68l-4.79 5.17zm11.99-11.1c.06 2.37-1.17 4.79-3.27 6.53l-4.4-4.4c1.74-2.1 4.16-3.33 6.53-3.27.14 1.36.18 1.27.17.14l-.03 1zm-10 7.84l-1.52-1.52 4.4 4.4zm-8.5 3.41l2.11-2.11 1.41 1.41-2.11 2.11L3.5 17.96zm9.5-3.5c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z");
    /// <summary>The built-in <c>local_fire_department</c> icon.</summary>
    public static FlareSvgIcon LocalFireDepartment { get; } = Reg("local_fire_department", "M12 23c4.97 0 9-4.03 9-9 0-4.59-3.13-8.43-7.37-9.53C15.38 6.25 16 8.06 16 10c0 2.21-1.79 4-4 4s-4-1.79-4-4c0-.78.23-1.51.62-2.13C6.88 9.37 6 11.08 6 13c0 3.87 2.69 7.12 6.3 7.87L12 21v2zm0-4c-1.66 0-3-1.34-3-3 0-.95.45-1.8 1.14-2.34.65.98 1.74 1.67 3 1.67 1.1 0 2.07-.48 2.74-1.25.17.3.26.64.26 1 0 1.66-1.34 3-3.14 3z");
    /// <summary>The built-in <c>flash_on</c> icon.</summary>
    public static FlareSvgIcon FlashOn { get; } = Reg("flash_on", "M7 2v11h3v9l7-12h-4l4-8z");
    /// <summary>The built-in <c>speed</c> icon.</summary>
    public static FlareSvgIcon Speed { get; } = Reg("speed", "M20.38 8.57l-1.23 1.85a8 8 0 0 1-.22 7.58H5.07A8 8 0 0 1 15.58 6.85l1.85-1.23A10 10 0 0 0 3.35 19a2 2 0 0 0 1.72 1h13.85a2 2 0 0 0 1.74-1 10 10 0 0 0-.27-10.44zm-9.79 6.84a2 2 0 0 0 2.83 0l5.66-8.49-8.49 5.66a2 2 0 0 0 0 2.83z");

    // -- Component chrome (used by default component rendering) ----------------
    /// <summary>The built-in <c>drag_indicator</c> icon.</summary>
    public static FlareSvgIcon DragIndicator { get; } = Reg("drag_indicator", "M11 18c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2zm-2-8c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 4c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z");
    /// <summary>The built-in <c>keyboard_arrow_up</c> icon.</summary>
    public static FlareSvgIcon KeyboardArrowUp { get; } = Reg("keyboard_arrow_up", "M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z");
    /// <summary>The built-in <c>filter_alt</c> icon.</summary>
    public static FlareSvgIcon FilterAlt { get; } = Reg("filter_alt", "M4.25 5.61C6.27 8.2 10 13 10 13v6c0 .55.45 1 1 1h2c.55 0 1-.45 1-1v-6c0 0 3.72-4.8 5.74-7.39C20.25 4.95 19.78 4 18.95 4H5.04C4.21 4 3.74 4.95 4.25 5.61z");
    /// <summary>The built-in <c>view_column</c> icon.</summary>
    public static FlareSvgIcon ViewColumn { get; } = Reg("view_column", "M14.67 5v14H9.33V5h5.34zm1 14H21V5h-5.33v14zM8.33 19V5H3v14h5.33z");
    /// <summary>The built-in <c>description</c> icon.</summary>
    public static FlareSvgIcon Description { get; } = Reg("description", "M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z");
    /// <summary>The built-in <c>upload_file</c> icon.</summary>
    public static FlareSvgIcon UploadFile { get; } = Reg("upload_file", "M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15.01l1.41 1.41L11 14.84V19h2v-4.16l1.59 1.59L16 15.01 12.01 11z");
    /// <summary>The built-in <c>create_new_folder</c> icon.</summary>
    public static FlareSvgIcon CreateNewFolder { get; } = Reg("create_new_folder", "M20 6h-8l-2-2H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-1 8h-3v3h-2v-3h-3v-2h3V9h2v3h3v2z");
    ...
    // Media-player controls (Material Symbols, 960 grid).
    /// <summary>The <c>pause</c> icon.</summary>
    public static FlareSvgIcon Pause { get; } = Reg("pause", """<path d="M585-200q-24.75 0-42.37-17.63Q525-235.25 525-260v-440q0-24.75 17.63-42.38Q560.25-760 585-760h115q24.75 0 42.38 17.62Q760-724.75 760-700v440q0 24.75-17.62 42.37Q724.75-200 700-200H585Zm-325 0q-24.75 0-42.37-17.63Q200-235.25 200-260v-440q0-24.75 17.63-42.38Q235.25-760 260-760h115q24.75 0 42.38 17.62Q435-724.75 435-700v440q0 24.75-17.62 42.37Q399.75-200 375-200H260Zm325-60h115v-440H585v440Zm-325 0h115v-440H260v440Zm0-440v440-440Zm325 0v440-440Z"/>""", "0 -960 960 960");
    /// <summary>The <c>play_arrow</c> icon.</summary>
    public static FlareSvgIcon PlayArrow { get; } = Reg("play_arrow", """<path d="M320-258v-450q0-14 9-22t21-8q4 0 8 1t8 3l354 226q7 5 10.5 11t3.5 14q0 8-3.5 14T720-458L366-232q-4 2-8 3t-8 1q-12 0-21-8t-9-22Zm60-225Zm0 171 269-171-269-171v342Z"/>""", "0 -960 960 960");
    /// <summary>The <c>volume_off</c> icon.</summary>
    public static FlareSvgIcon VolumeOff { get; } = Reg("volume_off", """<path d="M681-188q-17 12-35.5 22T607-148q-12 5-24.5 0T565-165q-5-11 .5-22t17.5-16q15-5 28.5-12t26.5-17L473-397v165q0 20-18.5 27.5T422-211L273-360H143q-13 0-21.5-8.5T113-390v-180q0-13 8.5-21.5T143-600h126L70-799q-9-9-8.5-21.5T71-842q9-9 21.5-9t21.5 9l721 721q9 9 9 21.5T835-78q-9 9-22 9t-22-9L681-188Zm92-293q0-93-52.5-168.5T583-759q-12-5-17-16t0-22q5-12 17.5-16.5t25.5.5q101 41 162.5 130.5T833-481q0 38-7.5 75T802-334q-8 17-19.5 20.5T760-315q-11-5-16.5-14.5t.5-20.5q15-30 22-63t7-68ZM576-628q38 23 57.5 63.5T653-480v15q0 7-2 15-2 10-11 13t-17-5l-61-61q-5-5-7-10t-2-11v-91q0-9 7.5-13.5t15.5.5Zm-196-57q-5-5-5-11t5-11l42-42q14-14 32.5-6.5T473-728v100q0 10-9.5 13.5T447-618l-67-67Zm33 379v-150l-84-84H173v120h126l114 114Zm-42-192Z"/>""", "0 -960 960 960");
    /// <summary>The <c>volume_up</c> icon.</summary>
    public static FlareSvgIcon VolumeUp { get; } = Reg("volume_up", """<path d="M780-481q0-94-52.5-169T590-759q-12-5-17-16t0-22q5-12 17.5-16.5t25.5.5q101 41 162.5 131T840-481q0 111-61.5 201T616-149q-13 5-25.5.5T573-165q-5-11 0-22t17-16q85-34 137.5-109T780-481ZM280-360H150q-13 0-21.5-8.5T120-390v-180q0-13 8.5-21.5T150-600h130l149-149q14-14 32.5-6.5T480-728v496q0 20-18.5 27.5T429-211L280-360Zm380-120q0 52-26 94t-73 64q-8 4-14.5-1t-6.5-13v-289q0-8 6.5-13t14.5-1q47 22 73 65t26 94ZM420-648 307-540H180v120h127l113 109v-337ZM298-480Z"/>""", "0 -960 960 960");

    /// <summary>All built-in icon ids, sorted alphabetically.</summary>
    public static IEnumerable<string> All => _byId.Keys.OrderBy(id => id);

    /// <summary>Looks up a built-in icon by its snake_case id (e.g. <c>"chevron_left"</c>); null if absent.</summary>
    public static FlareSvgIcon? Find(string id) => _byId.TryGetValue(id, out var icon) ? icon : null;
    ...
    public static class Brands
    {
        ...
        /// scaled into the shared 24x24 icon viewBox. Pass to <c>FlareIconView</c>'s <c>Icon</c>
        /// (named in prose, not linked: it lives in Flare.Components, which this package does not
        /// reference).</summary>
