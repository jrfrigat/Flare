...
**100+ компонентов · 5 дизайн-систем × 28 палитр × светлая/тёмная/авто · единый API цвета · нет зависимостей от сторонних CSS · Docker-готовая галерея**
...
```
Flare.Core              ← ITheme, IThemeService, FlareComponentBase, дизайн-токены, абстракции
...
- Переключателем темы (дизайн-система × палитра × режим) с генерацией палитры из цвета
