...
**190+ компонентов - своя тема на семантических токенах - 7 необязательных preset-дизайн-систем x 30+ палитр (+ Dynamic Color) x светлая/темная/авто - нет зависимостей от сторонних CSS - Docker-готовая галерея**
