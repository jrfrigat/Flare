...
| --- | --- | --- | --- | --- | --- |
| `ChildContent` | `RenderFragment?` | `` | Parameter |  | The toolbar's command buttons and controls. |
| `Dense` | `bool` | `false` | Parameter |  | Tightens spacing and button size for a denser bar. |
