...
**Blocked on / see also:** the per-size geometry is currently broken under MD3 - see
[flareslider-md3-geometry-regression.md](flareslider-md3-geometry-regression.md). Fix that first; any
hairline-track work builds on the same tokens.
