...
| [Icons](en/icons.md) | FlareIcon system, built-in set, provider packages, trimming |
...
| [Иконки](ru/icons.md) | Система FlareIcon, встроенный набор, пакеты провайдеров, тримминг |
