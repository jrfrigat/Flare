...
### drawer/_variables.scss

Source: <https://cdn.jsdelivr.net/npm/@material/drawer@14.0.0/_variables.scss>
...
| `$surface-fill-color` | surface | Opacity |
...
| `$divider-opacity` | 0.12 | Widths |
| `$width` | 256px |  |
| `$list-item-spacing` | 4px |  |
| `$surface-padding` | 16px |  |
| `$shape-radius` | large |  |
| `$item-shape-radius` | small | Animations |
| `$animation-enter` | 250ms |  |
| `$animation-exit` | 200ms | Scrim |
