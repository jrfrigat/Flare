...
public class TokenParityTests
{
    ...
    private static ColorScheme CreateDefaultColorScheme()
    {
        return new ColorScheme
        {
            ...
            SurfaceBright = "#E6E0E9",
            SurfaceDim = "#E6E0E9",
            PrimaryFixed = "#E6E0E9",
            PrimaryFixedDim = "#E6E0E9",
            OnPrimaryFixed = "#E6E0E9",
            OnPrimaryFixedVariant = "#E6E0E9",
            SecondaryFixed = "#E6E0E9",
            SecondaryFixedDim = "#E6E0E9",
            OnSecondaryFixed = "#E6E0E9",
            OnSecondaryFixedVariant = "#E6E0E9",
            TertiaryFixed = "#E6E0E9",
            TertiaryFixedDim = "#E6E0E9",
            OnTertiaryFixed = "#E6E0E9",
            OnTertiaryFixedVariant = "#E6E0E9",
            Background = "#FFFBFE",
            OnBackground = "#1C1B1F",
            Outline = "#79747E",
