...
public class FlareIconTests : FlareTestContext
{
    ...
    {
        var cut = RenderComponent<FlareIcon>(p => p.Add(x => x.Icon, name));
    ...
    {
        var cut = RenderComponent<FlareIcon>(p => p.Add(x => x.Name, "share"));
    ...
    {
        var cut = RenderComponent<FlareIcon>(p => p.Add(x => x.Icon, d));
    ...
    {
        var cut = RenderComponent<FlareIcon>(p => p
