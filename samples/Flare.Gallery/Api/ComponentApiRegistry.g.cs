...
public static class ComponentApiRegistry
{
    ...
    private static Dictionary<string, ApiComponentInfo> Build()
    {
        ...
        c[@"FlareCarousel"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"AutoPlay", @"bool", @"false", @"Automatically advances slides on a timer.", null, false, false, false, @"FlareCarousel"),
                new ApiParameterInfo(@"AutoPlayIntervalMs", @"int", @"4000", @"Milliseconds between automatic slide advances.", null, false, false, false, @"FlareCarousel"),
                ...
                new ApiParameterInfo(@"Loop", @"bool", @"true", @"Wraps from the last slide back to the first.", null, false, false, false, @"FlareCarousel"),
                new ApiParameterInfo(@"ShowArrows", @"bool", @"true", @"Shows previous and next navigation arrow buttons.", null, false, false, false, @"FlareCarousel"),
                new ApiParameterInfo(@"ShowDots", @"bool", @"true", @"Shows dot indicators for direct slide navigation.", null, false, false, false, @"FlareCarousel"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
        ...
        c[@"FlareCheckbox"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"For", @"Expression<Func<TValue?>>?", null, @"Expression naming the model property this box edits, so the enclosing form can validate it and show the message. It is typed TValue like Value, so the two always name the same property - point both at a bool for a consent box (@bind-Value=""Model.Accepted"" For=""@(() => Model.Accepted)"").", null, false, false, false, @"FlareCheckbox"),
                ...
                new ApiParameterInfo(@"Value", @"TValue?", null, @"Whether the box is checked. With TValue=""bool?"" the value is tri-state and null is the indeterminate (""some of the below"") state; with TValue=""bool"" there are two states and the box can be validated against a plain bool on the model.", null, false, false, false, @"FlareCheckbox"),
                new ApiParameterInfo(@"ValueChanged", @"EventCallback<TValue?>", null, @"Callback invoked when the checked state changes. A click always produces true or false - it resolves the indeterminate state rather than cycling back into it.", null, false, true, false, @"FlareCheckbox"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
        ...
        c[@"FlareColumn"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"ColSpan", @"int", @"1", @"Grid-column span for this field inside a composite row (default 1).", null, false, false, false, @"FlareColumn"),
                ...
                new ApiParameterInfo(@"CompositeMode", @"CompositeMode", @"CompositeMode.Banded", @"How the composite lays out: Banded (default; each record spans several table rows, fields align across the table) or Card (all fields in one cell as a CSS grid).", null, false, false, false, @"FlareColumn"),
                ...
                new ApiParameterInfo(@"Editable", @"bool", @"false", @"Marks the column cells as editable.", null, false, false, false, @"FlareColumn"),
                ...
                new ApiParameterInfo(@"Filterable", @"bool", @"false", @"Shows a filter input in the column header filter row.", null, false, false, false, @"FlareColumn"),
                ...
                new ApiParameterInfo(@"Resizable", @"bool", @"false", @"Allows the user to resize this column by dragging.", null, false, false, false, @"FlareColumn"),
                ...
                new ApiParameterInfo(@"SortPriority", @"int", @"0", @"Initial sort priority in multi-column sort order.", null, false, false, false, @"FlareColumn"),
                new ApiParameterInfo(@"Sortable", @"bool", @"false", @"Enables click-to-sort on this column.", null, false, false, false, @"FlareColumn"),
        ...
        c[@"FlareCombobox"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Fuzzy", @"bool", @"false", @"Ranks local matches by fuzzy relevance (via FlareSearch) instead of insertion order.", null, false, false, false, @"FlareCombobox"),
                ...
                new ApiParameterInfo(@"MaxItems", @"int", @"10", @"Maximum number of async results to display. Default: 10.", null, false, false, false, @"FlareCombobox"),
                new ApiParameterInfo(@"MinChars", @"int", @"1", @"Minimum number of typed characters before an async search runs. Default: 1.", null, false, false, false, @"FlareCombobox"),
                ...
                new ApiParameterInfo(@"Open", @"bool", @"false", @"Whether the dropdown is open (supports @bind-Open).", null, false, false, false, @"FlareCombobox"),
                ...
                new ApiParameterInfo(@"VirtualizeThreshold", @"int", @"50", @"Option count above which the dropdown virtualizes (when not grouped). Default: 50.", null, false, false, false, @"FlareCombobox"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
        ...
        c[@"FlareDataGrid"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Dense", @"bool", @"false", @"Compact row height and cell padding for dense tables.", null, false, false, false, @"FlareDataGrid"),
                new ApiParameterInfo(@"EditMode", @"DataGridEditMode", @"DataGridEditMode.None", @"Edit mode: None (default), Inline (row), or Cell (click individual cells).", null, false, false, false, @"FlareDataGrid"),
                ...
                new ApiParameterInfo(@"FilterMode", @"DataGridFilterMode", @"DataGridFilterMode.Simple", @"Controls how column filters are displayed: Simple (text inputs), Menu (dropdowns), or Both.", null, false, false, false, @"FlareDataGrid"),
                ...
                new ApiParameterInfo(@"LoadingIndicator", @"DataGridLoadingIndicator", @"DataGridLoadingIndicator.Spinner", @"How the loading state is shown: a circular ring (default), skeleton rows, or text only.", null, false, false, false, @"FlareDataGrid"),
                ...
                new ApiParameterInfo(@"ReorderableColumns", @"bool", @"false", @"Enables drag-and-drop reordering of columns by dragging their headers.", null, false, false, false, @"FlareDataGrid"),
                ...
                new ApiParameterInfo(@"RowReorderable", @"bool", @"false", @"Enables drag-and-drop reordering of rows. Reordering raises OnRowReordered; the owner updates the backing data (the grid does not mutate Items).", null, false, false, false, @"FlareDataGrid"),
                ...
                new ApiParameterInfo(@"SelectionMode", @"SelectionMode", @"SelectionMode.None", @"Row selection mode - none, single, or multiple.", null, false, false, false, @"FlareDataGrid"),
                new ApiParameterInfo(@"ShowColumnPicker", @"bool", @"false", @"Shows a built-in ""Columns"" button in the toolbar that opens a checklist to show/hide individual columns. Hidden columns are tracked by their key (Id / SortKey / Title).", null, false, false, false, @"FlareDataGrid"),
                new ApiParameterInfo(@"ShowPager", @"bool", @"true", @"Whether the grid renders its own built-in pager below the table (default true). Set to false to suppress it and place a FlareDataGridPager yourself (e.g. in FooterContent or ToolbarContent).", null, false, false, false, @"FlareDataGrid"),
                new ApiParameterInfo(@"StickyHeader", @"bool", @"true", @"Keeps the header group - band rows, column titles and the filter row - pinned to the top of the table container while the rows scroll under it. Default true. Turn it off for a tall multi-row header that would eat the visible area, or for a print-shaped view where the header should scroll away with its rows. Has no visible effect on a grid with no height of its own, which does not scroll on its own to begin with. Pinned rows (PinnedTopRows, PinnedBottomRows) and the aggregate footer are separate promises and are not affected.", null, false, false, false, @"FlareDataGrid"),
                new ApiParameterInfo(@"Striped", @"bool", @"false", @"Alternating row background (""zebra"" striping).", null, false, false, false, @"FlareDataGrid"),
        ...
        c[@"FlareDataGridFilterPresets"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Size", @"FieldSize", @"FieldSize.Sm", @"Field size of the select.", null, false, false, false, @"FlareDataGridFilterPresets"),
        ...
        c[@"FlareDataGridPager"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"BoundaryCount", @"int", @"1", @"How many page buttons to always show at each end (passed to the pagination control).", null, false, false, false, @"FlareDataGridPager"),
                ...
                new ApiParameterInfo(@"ShowFirstLast", @"bool", @"false", @"Shows first/last jump buttons in addition to prev/next.", null, false, false, false, @"FlareDataGridPager"),
                new ApiParameterInfo(@"SiblingCount", @"int", @"2", @"How many page buttons to show on each side of the current page (passed to the pagination control).", null, false, false, false, @"FlareDataGridPager"),
                new ApiParameterInfo(@"Size", @"PaginationSize", @"PaginationSize.Md", @"Visual size of the pagination control.", null, false, false, false, @"FlareDataGridPager"),
                new ApiParameterInfo(@"Context", @"DataGridContext<TItem?>?", null, @"The grid context this control drives. Set it to place the control anywhere on the page; omit it inside a grid, where the cascade supplies one.", null, false, false, false, @"FlareDataGridControl"),
                new ApiParameterInfo(@"Grid", @"FlareDataGrid<TItem?>?", null, @"The grid this control drives, as an alternative to Context when the page already holds an @ref to the grid itself.", null, false, false, false, @"FlareDataGridControl"),
            },
            System.Array.Empty<ApiMethodInfo>(),
        ...
        c[@"FlareDataGridQuickFilter"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"DebounceMs", @"int", @"250", @"Debounce delay in milliseconds before the filter is applied (default 250).", null, false, false, false, @"FlareDataGridQuickFilter"),
                ...
                new ApiParameterInfo(@"Size", @"FieldSize", @"FieldSize.Sm", @"Field size of the search box.", null, false, false, false, @"FlareDataGridQuickFilter"),
                new ApiParameterInfo(@"Context", @"DataGridContext<TItem?>?", null, @"The grid context this control drives. Set it to place the control anywhere on the page; omit it inside a grid, where the cascade supplies one.", null, false, false, false, @"FlareDataGridControl"),
                new ApiParameterInfo(@"Grid", @"FlareDataGrid<TItem?>?", null, @"The grid this control drives, as an alternative to Context when the page already holds an @ref to the grid itself.", null, false, false, false, @"FlareDataGridControl"),
            },
            new ApiMethodInfo[]
        ...
        c[@"FlareDataTree"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Height", @"string", @"""400px""", @"CSS height of the virtualized scrollable container.", null, false, false, false, @"FlareDataTree"),
        ...
        c[@"FlareFormBuilder"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"ShowReset", @"bool", @"true", @"Shows a reset button alongside the submit button.", null, false, false, false, @"FlareFormBuilder"),
        ...
        c[@"FlareKanban"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"ReadOnly", @"bool", @"false", @"Disables pointer and keyboard card movement while preserving readable, focusable card content.", null, false, false, false, @"FlareKanban"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
        ...
        c[@"FlareList"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Dense", @"bool", @"false", @"Reduces vertical padding for a compact appearance.", null, false, false, false, @"FlareList"),
                new ApiParameterInfo(@"Height", @"string", @"""400px""", @"Fixed height of the virtualized container.", null, false, false, false, @"FlareList"),
                ...
                new ApiParameterInfo(@"OverscanCount", @"int", @"3", @"Number of extra items rendered outside the visible viewport.", null, false, false, false, @"FlareList"),
                new ApiParameterInfo(@"Virtual", @"bool", @"false", @"Enables Blazor Virtualize for large datasets.", null, false, false, false, @"FlareList"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
        ...
        c[@"FlareMultiSelect"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Fuzzy", @"bool", @"false", @"Ranks filtered options by fuzzy relevance instead of insertion order.", null, false, false, false, @"FlareMultiSelect"),
                ...
                new ApiParameterInfo(@"MaxSelections", @"int", @"0", @"Maximum number of selected items; 0 means unlimited.", null, false, false, false, @"FlareMultiSelect"),
                ...
                new ApiParameterInfo(@"Open", @"bool", @"false", @"Whether the dropdown is open (supports @bind-Open).", null, false, false, false, @"FlareMultiSelect"),
                ...
                new ApiParameterInfo(@"Searchable", @"bool", @"false", @"Shows an in-field search input that filters the options as the user types.", null, false, false, false, @"FlareMultiSelect"),
                new ApiParameterInfo(@"ShowSelectAll", @"bool", @"false", @"Shows a select-all row at the top of the dropdown.", null, false, false, false, @"FlareMultiSelect"),
                ...
                new ApiParameterInfo(@"VirtualizeThreshold", @"int", @"50", @"Option count above which the dropdown virtualizes (when not grouped). Default: 50.", null, false, false, false, @"FlareMultiSelect"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Disabled", @"bool", @"false", @"Disables the field (no input, dimmed).", null, false, false, false, @"FlareFieldBase"),
                new ApiParameterInfo(@"ErrorText", @"string?", null, @"Error text; when set it overrides HelperText and marks the field invalid.", null, false, false, false, @"FlareFieldBase"),
        ...
        c[@"FlareNumericField"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"Clearable", @"bool", @"false", @"Shows a clear (x) button inside the field when it has a value.", null, false, false, false, @"FlareNumericField"),
                ...
                new ApiParameterInfo(@"DebounceInterval", @"int", @"0", @"Debounce in milliseconds for Immediate updates. 0 = no debounce.", null, false, false, false, @"FlareNumericField"),
                ...
                new ApiParameterInfo(@"Immediate", @"bool", @"false", @"When true, the value updates on every keystroke (oninput) rather than only on change/blur.", null, false, false, false, @"FlareNumericField"),
                ...
                new ApiParameterInfo(@"SelectAllOnFocus", @"bool", @"false", @"Selects the whole value when the field gains focus (so the next keystroke replaces it).", null, false, false, false, @"FlareNumericField"),
                new ApiParameterInfo(@"ShowStepper", @"bool", @"false", @"Shows up/down stepper buttons that increment/decrement by Step (default 1).", null, false, false, false, @"FlareNumericField"),
        ...
        c[@"FlareOptionList"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"HighlightedIndex", @"int", @"-1", @"The highlighted option index (into the filtered options); -1 for none.", null, false, false, false, @"FlareOptionList"),
                ...
                new ApiParameterInfo(@"Multiselectable", @"bool", @"false", @"Sets aria-multiselectable on the listbox root.", null, false, false, false, @"FlareOptionList"),
                ...
                new ApiParameterInfo(@"PreventMouseDownDefault", @"bool", @"false", @"Prevents the default mousedown so clicking an option does not blur the host's input.", null, false, false, false, @"FlareOptionList"),
                ...
                new ApiParameterInfo(@"ShowCheck", @"bool", @"false", @"Renders a trailing check mark on the selected option (single-select).", null, false, false, false, @"FlareOptionList"),
                new ApiParameterInfo(@"ShowCheckbox", @"bool", @"false", @"Renders a leading visual checkbox on each option (multi-select).", null, false, false, false, @"FlareOptionList"),
                new ApiParameterInfo(@"Virtualize", @"bool", @"false", @"Enables virtualized rendering above VirtualizeThreshold when not grouped.", null, false, false, false, @"FlareOptionList"),
                new ApiParameterInfo(@"VirtualizeThreshold", @"int", @"50", @"Option count above which virtualized rendering kicks in. Default: 50.", null, false, false, false, @"FlareOptionList"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
        ...
        c[@"FlareRadio"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Disabled", @"bool", @"false", @"Disables this radio button individually.", null, false, false, false, @"FlareRadio"),
        ...
        c[@"FlareRadioGroup"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Disabled", @"bool", @"false", @"Disables all radio buttons in the group.", null, false, false, false, @"FlareRadioGroup"),
                ...
                new ApiParameterInfo(@"Inline", @"bool", @"false", @"Arranges radio buttons horizontally when true.", null, false, false, false, @"FlareRadioGroup"),
                new ApiParameterInfo(@"Label", @"string?", null, @"Legend label shown above the group.", null, false, false, false, @"FlareRadioGroup"),
                new ApiParameterInfo(@"LabelPlacement", @"LabelPlacement", @"LabelPlacement.End", @"Label position relative to each radio (End = after, Start = before). Default End.", null, false, false, false, @"FlareRadioGroup"),
                new ApiParameterInfo(@"Size", @"FieldSize", @"FieldSize.Md", @"Control size (Xs..Xl) applied to every radio in the group. Medium is the default.", null, false, false, false, @"FlareRadioGroup"),
        ...
        c[@"FlareRichTextEditor"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Sanitize", @"bool", @"true", @"Whether Value and pasted markup are filtered before being shown. true by default: an editor whose value survives a round trip through storage is exactly where a script smuggled into the markup would be executed again on every later view. Turning it off is a statement that the markup is trusted, and it is the caller's to make - not a convenience. The editor's own formatting never needs it: everything the toolbar produces is inside the allowlist.", null, false, false, false, @"FlareRichTextEditor"),
        ...
        c[@"FlareSelect"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Open", @"bool", @"false", @"Whether the dropdown is open (supports @bind-Open).", null, false, false, false, @"FlareSelect"),
                ...
                new ApiParameterInfo(@"Searchable", @"bool", @"false", @"Shows an in-field search input that filters the options as the user types.", null, false, false, false, @"FlareSelect"),
                ...
                new ApiParameterInfo(@"VirtualizeThreshold", @"int", @"50", @"Option count above which the dropdown virtualizes (when not grouped). Default: 50.", null, false, false, false, @"FlareSelect"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Disabled", @"bool", @"false", @"Disables the field (no input, dimmed).", null, false, false, false, @"FlareFieldBase"),
                new ApiParameterInfo(@"ErrorText", @"string?", null, @"Error text; when set it overrides HelperText and marks the field invalid.", null, false, false, false, @"FlareFieldBase"),
        ...
        c[@"FlareTable"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"Bordered", @"bool", @"false", @"Adds borders around all cells.", null, false, false, false, @"FlareTable"),
                ...
                new ApiParameterInfo(@"ColSpan", @"int", @"100", @"Number of columns (used for group-row colspan).", null, false, false, false, @"FlareTable"),
                new ApiParameterInfo(@"Dense", @"bool", @"false", @"Reduces cell padding for a denser layout (consistent with other components' Dense).", null, false, false, false, @"FlareTable"),
                ...
                new ApiParameterInfo(@"Hover", @"bool", @"true", @"Highlights the row under the cursor.", null, false, false, false, @"FlareTable"),
                ...
                new ApiParameterInfo(@"ShowFooter", @"bool", @"false", @"When true, renders a <tfoot> using FooterContent.", null, false, false, false, @"FlareTable"),
                new ApiParameterInfo(@"StickyHeader", @"bool", @"false", @"Pins the table header while the body scrolls.", null, false, false, false, @"FlareTable"),
                new ApiParameterInfo(@"Striped", @"bool", @"false", @"Alternates row background colors for readability.", null, false, false, false, @"FlareTable"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
        ...
        c[@"FlareTagField"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"AddOnBlur", @"bool", @"true", @"Adds the current input as a tag when focus leaves the field. Default: true.", null, false, false, false, @"FlareTagField"),
                new ApiParameterInfo(@"AllowDuplicates", @"bool", @"false", @"Allows adding duplicate tags. Requires a reference/value type whose equality permits it.", null, false, false, false, @"FlareTagField"),
                ...
                new ApiParameterInfo(@"DebounceMs", @"int", @"200", @"Debounce in milliseconds before querying SearchFunc. Default: 200ms.", null, false, false, false, @"FlareTagField"),
                ...
                new ApiParameterInfo(@"MaxSuggestions", @"int", @"8", @"Maximum number of suggestions shown. Default: 8.", null, false, false, false, @"FlareTagField"),
                new ApiParameterInfo(@"MaxTags", @"int", @"0", @"Maximum number of tags; 0 means unlimited.", null, false, false, false, @"FlareTagField"),
                new ApiParameterInfo(@"MinChars", @"int", @"1", @"Minimum characters typed before suggestions appear. Default: 1.", null, false, false, false, @"FlareTagField"),
        ...
        c[@"FlareThemeProvider"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Stylesheets", @"ThemeStylesheets", @"ThemeStylesheets.Automatic", @"Whether the provider writes the theme stylesheet links itself (Automatic, the default) or the application has put them in its own head (Manual), which lets a WebAssembly app fetch them before .NET starts. In both modes the provider waits for the active theme's sheets and the active palette's StyleAsset to load and adds any that are missing.", null, false, false, false, @"FlareThemeProvider"),
            },
            new ApiMethodInfo[]
            {
                new ApiMethodInfo(@"DisposeAsync", @"DisposeAsync()", @"ValueTask", null, null,
        ...
        c[@"FlareToggleGroup"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"CheckMark", @"bool", @"false", @"Shows a leading checkmark on each selected button.", null, false, false, false, @"FlareToggleGroup"),
                ...
                new ApiParameterInfo(@"Disabled", @"bool", @"false", @"When true, disables every child FlareToggleButton in the group.", null, false, false, false, @"FlareToggleGroup"),
                new ApiParameterInfo(@"Mandatory", @"bool", @"false", @"Single-select only: when true the active button cannot be deselected by clicking it (one selection is always kept). Default false - single-select is deselectable (a ""toggle"" selection).", null, false, false, false, @"FlareToggleGroup"),
                new ApiParameterInfo(@"MultiSelect", @"bool", @"false", @"Allows multiple buttons to be active simultaneously.", null, false, false, false, @"FlareToggleGroup"),
                new ApiParameterInfo(@"Orientation", @"string", @"""horizontal""", @"""horizontal"" (default) or ""vertical"".", null, false, false, false, @"FlareToggleGroup"),
        ...
        c[@"FlareTransfer"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"SourceTitle", @"string", @"""Available""", @"Header label shown above the source panel.", null, false, false, false, @"FlareTransfer"),
                ...
                new ApiParameterInfo(@"TargetTitle", @"string", @"""Selected""", @"Header label shown above the target panel.", null, false, false, false, @"FlareTransfer"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
        ...
        c[@"FlareVirtualList"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                new ApiParameterInfo(@"Height", @"string", @"""400px""", @"CSS height of the scrollable container.", null, false, false, false, @"FlareVirtualList"),
                ...
                new ApiParameterInfo(@"OverscanCount", @"int", @"3", @"Number of extra items rendered outside the visible viewport.", null, false, false, false, @"FlareVirtualList"),
                new ApiParameterInfo(@"AdditionalAttributes", @"IReadOnlyDictionary<string, object>?", null, @"Additional attributes.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Class", @"string?", null, @"Additional CSS class(es) appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
                new ApiParameterInfo(@"Style", @"string?", null, @"Inline style string appended to the component's root element.", null, false, false, false, @"FlareComponentBase"),
            },
    ...
    private static Dictionary<string, ApiEnumInfo> BuildEnums()
    {
        ...
        e[@"ThemeStylesheets"] = new ApiEnumInfo(
            @"ThemeStylesheets",
