    ...
    private static Dictionary<string, ApiComponentInfo> Build()
    {
        ...
        c[@"FlareThemeProvider"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Stylesheets", @"ThemeStylesheets", @"ThemeStylesheets.Automatic", @"Whether the provider writes the theme stylesheet links itself (Automatic, the default) or the application has put them in its own head (Manual), which lets a WebAssembly app fetch them before .NET starts. In both modes the provider waits for the active theme's sheets to load and adds any that are missing.", null, false, false, false, @"FlareThemeProvider"),
            },
            new ApiMethodInfo[]
            {
                new ApiMethodInfo(@"DisposeAsync", @"DisposeAsync()", @"ValueTask", null, null,
