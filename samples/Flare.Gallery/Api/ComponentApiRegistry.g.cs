    ...
    private static Dictionary<string, ApiComponentInfo> Build()
    {
        ...
        c[@"FlareProgress"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Variant", @"ProgressVariant", @"ProgressVariant.Linear", @"Base progress structure. Theme-specific visual variants can be selected through Class using a class exported by the theme package.", null, false, false, false, @"FlareProgress"),
