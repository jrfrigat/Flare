    ...
    private static Dictionary<string, ApiComponentInfo> Build()
    {
        ...
        c[@"FlareDataGrid"] = new ApiComponentInfo(
            ...
            new ApiParameterInfo[]
            {
                ...
                new ApiParameterInfo(@"Height", @"string", null, @"CSS height of the table container. Works with or without virtualization. Ignored when FillHeight is set.", null, false, false, false, @"FlareDataGrid"),
