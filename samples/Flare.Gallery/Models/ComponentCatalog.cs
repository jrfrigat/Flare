...
/// <param name="Href">
/// Route of the demo page, written WITHOUT a leading slash so it resolves against the document's
/// <c>&lt;base href&gt;</c>. The gallery is served both at a site root (the Docker image) and under a
/// sub-path (GitHub Pages serves it at <c>/Flare/</c>); a leading slash would resolve against the
/// origin instead and navigate straight out of the app.
/// </param>
...
public static class ComponentCatalog
{
    ...
    public static readonly IReadOnlyList<ComponentEntry> All = new[]
    {
        ...
        new ComponentEntry("components/utilities-batch",   "Utilities",               "Parity_Title",          ComponentGroup.Utilities),
